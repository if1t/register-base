...
1. В **angular.json** Добавить ассеты меню (выше определения директории assets проекта). Путь - app -> architect -> build -> options -> assets:
    ...
    {
      "glob": "**/*",
      "input": "projects/ngx-page-menu/src/assets",
      "output": "assets/ngx-page-menu"
    },
    ```
...
#### Все svg файлы хранятся по пути `/assets/ngx-page-menu/`

1. Логотип (открытое состояние меню): `/assets/ngx-page-menu/logo/logo.svg`
1. Логотип (закрытое состояние меню): `/assets/ngx-page-menu/logo/logo_closed.svg`
1. Шеврон вправо: `/assets/ngx-page-menu/chevrons/chevron-right.svg`
1. Шеврон вправо: `/assets/ngx-page-menu/chevrons/chevron-up.svg`
1. Шеврон меню (клювик): `/assets/ngx-page-menu/chevrons/menu-chevron.svg`
1. Все иконки которые должно отображать меню на первом уровне: `/assets/ngx-page-menu/page-menu`
